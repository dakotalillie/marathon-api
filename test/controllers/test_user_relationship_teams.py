...
def test_user_relationship_teams_varying_semantic_errors(client, user1):
    """
...
def test_user_relationship_teams_same_semantic_errors_status(
...
def test_user_relationship_teams_some_duplicates(client, user1, team1, team2):
    """
...
def test_user_relationship_teams_all_duplicates(client, user1, team1):
    """
    GIVEN an existing user and team, with the user being a member of that team
